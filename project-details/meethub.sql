...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2023 at 06:00 AM
...
CREATE TABLE `address` (
  ...
  `p_division` int(3) NOT NULL,
  `p_disrict` int(3) NOT NULL,
  `p_thana` int(3) NOT NULL,
  `p_village` varchar(256) NOT NULL,
  `p_house` varchar(256) NOT NULL,
  `h_country` varchar(256) NOT NULL,
  `h_division` int(3) NOT NULL,
  `h_disrict` int(3) NOT NULL,
  `h_thana` int(3) NOT NULL,
  `h_village` varchar(256) NOT NULL,
  `h_house` varchar(256) NOT NULL,
...
INSERT INTO `address` (`id`, `user_id`, `p_country`, `p_division`, `p_disrict`, `p_thana`, `p_village`, `p_house`, `h_country`, `h_division`, `h_disrict`, `h_thana`, `h_village`, `h_house`, `created_at`) VALUES
(1, 1, 'Bangladesh', 1, 10, 88, 'Mirpur', '88', 'bangladesh', 4, 30, 230, 'ooo', '44', '2023-02-14 18:22:11');
...
INSERT INTO `educations` (`id`, `user_id`, `exam`, `board`, `Institute`, `year`, `result`, `created_at`) VALUES
(3, 1, 'jsc', 'Jessore', 'Nimtola High School', 2010, '3.00', '2023-02-19 03:01:47');
...
INSERT INTO `family_info` (`id`, `user_id`, `relation`, `name`, `profession`, `status`, `phone`, `created_at`) VALUES
(2, 1, 'mother', 'Mst Afroza Khatun', 'House Wife', 'Low', 1302460356, '2023-02-19 02:26:35');
...
CREATE TABLE `partner_preference` (
  ...
  `dislike_habbit` varchar(256) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `partner_preference` (`id`, `user_id`, `education`, `district`, `height`, `dislike_habbit`, `created_at`) VALUES
(2, 1, 'msc', 17, 5.70, 'asdf', '2023-02-19 02:59:51');
...
INSERT INTO `personal_info` (`id`, `user_id`, `height`, `weight`, `skin_color`, `religion`, `blood_group`, `hobby`, `profession`, `salary`, `created_at`) VALUES
(1, 1, '5.70', 50, 'Kala', 'islam', 'a+', 'asdfasdf', 'as', 3333, '2023-02-19 03:33:48');
...
INSERT INTO `social` (`id`, `user_id`, `name`, `link`, `created_at`) VALUES
(2, 0, 'github', 'https://github.com/SR-Sohan', '2023-02-19 02:34:52');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `phone`, `gender`, `password`, `role`, `status`, `created_at`) VALUES
(1, 'SR', 'Sohan', 'sr.sohanur22@gmail.com', 1302460356, 'male', '$2y$10$QRiFQdI.wd59Y531abZa6ux9VF.RM1zvv8LcDlnfZ2VXD3FD.KPAy', 1, 1, '2023-02-14 17:09:00'),
(2, 'SR', 'Sohan', 'sr.sohanur22@gmail.com', 1302460356, 'male', '$2y$10$abWXwXVIpCvWK81twBcQE./XP9Avph8T7BEbhgx5cNc9EL9PSePs.', 1, 1, '2023-02-14 17:24:16'),
(8, 'admin', 'admin', 'admin@gmail.com', 1302460356, 'male', '$2y$10$Xs/ta8ATBDGKH5tV/F5HdOGit.NmN6sNU38EOt0injdO7e89OadW2', 2, 1, '2023-02-19 04:56:23');
...
CREATE TABLE `wedding` (
  `id` int(5) NOT NULL,
  `bride_id` int(5) NOT NULL,
  `groom_id` int(5) NOT NULL,
  `date` date NOT NULL,
  `description` varchar(256) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `address`
  ...
  ADD KEY `p_division` (`p_division`),
  ADD KEY `p_disrict` (`p_disrict`),
  ADD KEY `p_thana` (`p_thana`),
  ADD KEY `h_division` (`h_division`),
  ADD KEY `h_disrict` (`h_disrict`),
  ADD KEY `h_thana` (`h_thana`);
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `fk_dis_id` FOREIGN KEY (`p_disrict`) REFERENCES `districts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_dis_id_2` FOREIGN KEY (`h_disrict`) REFERENCES `districts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_divi_id` FOREIGN KEY (`p_division`) REFERENCES `divisions` (`id`),
  ADD CONSTRAINT `fk_divi_id_2` FOREIGN KEY (`h_division`) REFERENCES `divisions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_thana_id` FOREIGN KEY (`p_thana`) REFERENCES `upazilas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_thana_id_2` FOREIGN KEY (`h_thana`) REFERENCES `upazilas` (`id`) ON DELETE CASCADE;
